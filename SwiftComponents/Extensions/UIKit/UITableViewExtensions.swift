...
public extension UITableView {
    ...
    ///
    /// - Parameter name: UITableViewCell type
    func register(nib cellClass: UITableViewCell.Type) {
        register(cellClass.nib, forCellReuseIdentifier: String(describing: cellClass))
    }
    
    func register(_ cellClass: UITableViewCell.Type) {
        register(cellClass, forCellReuseIdentifier: String(describing: cellClass))
    }
//    func register<T: UITableViewCell>(_ cellWithClass name: T.Type) {
